...
class TestInventory:
    ...
    def test_add_stock(self):
        ...
        inventory = Inventory(product_id="P001", current_stock=100, holding_cost_per_unit=2.5)
    ...
    def test_is_below_minimum(self):
        ...
        inventory = Inventory(
            product_id="P001", current_stock=15, holding_cost_per_unit=2.5, min_stock_level=20
        )
    ...
    def test_is_above_maximum(self):
        ...
        inventory = Inventory(
            product_id="P001", current_stock=250, holding_cost_per_unit=2.5, max_stock_level=200
        )
    ...
    def test_negative_current_stock_raises_error(self):
        ...
        with pytest.raises(ValueError, match="cannot be negative"):
            Inventory(product_id="P001", current_stock=-10, holding_cost_per_unit=2.5)
